...
Ejecución:
        python 1D_Calibracion_02_II.py entrada salida 
        ...
        Por ejemplo: python 1D_Calibracion_02_II.py INPUT_02 SALIDA
"""
...
try:
    ...
    mensaje = """ Error: La ejecucion de este programa requiere de 2 argumentos. 
        Ejecucion correcta: python 1D_Calibracion_02_II.py entrada salida
...
poisson1D.GraficaSolucion(x,u,xa,ua,GTit,NSolTit,ESolTit,"Calibracion_02_II.pdf")
