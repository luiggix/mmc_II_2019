...
try:
    ...
    mensaje = """ Error: La ejecucion de este programa requiere de 2 argumentos. 
        ...
        datos del problema :  (ax, ay) y (bx,by) son las coordenadas 
        inicial y final del dominio respectivamente; Nx y Ny son el numero 
        de incognitas en las direcciones correspondientes; A, B, C y D son las 
...
poisson2D.GraficaSuperficieC(xg,yg,u,'inferno')
