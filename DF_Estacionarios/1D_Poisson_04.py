...
Ejecución:
    ...
    python 1D_Poisson_04.py a b N A B
    ...
    Por ejemplo: python 1D_Poisson_04.py 0 1 10 1 0.1
"""
...
try:
    ...
    mensaje = """ Error: La ejecucion de este programa requiere de 5 argumentos. 
        Ejecucion correcta: python 1D_Poisson_04.py a b N A B
        donde a y b son las fronteras izq. y der. del dominio 
        respetivamente N es el numero de incognitas, A es una cond. 
        Dirichlet en a, mientras que B es una cond. Neumman en b.
        Por ejemplo: python 1D_Poisson_04.py 0 1 10 1 0.1 """
...
# Los valores en los extremos son conocidos debido a las cond de frontera.
u[0] = boundA
u[N+1] = h*boundB + u[N] # Esto debido a la cond. Neumman 
